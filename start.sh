...
# Download and install the Microsoft signing key for azure cli
...
print_header "1. Compiling python binaries..."

if [ ! -d "/azp/agent/_work/_tool/Python" ]; then
